...
urlpatterns = [
    ...
    path('student_center/choose_teacher/', S_Choice.as_view()),  # 学生填报志愿
    ...
    path('student_center/S_P_detail/', S_Progress_Detail.as_view()),  # 学生Progress详情，post可修改
    path('student_center/S_detail/', S_Detail.as_view()),   # 学生个人信息，学生个人查看修改
